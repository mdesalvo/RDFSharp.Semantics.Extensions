...
namespace RDFSharp.Semantics.Extensions.SKOS
{
    ...
    public class SKOSConceptSchemeLens
    {
        ...
        {
            if (skosConcept == null)
                throw new OWLSemanticsException("Cannot create data lens because given \"skosConcept\" parameter is null");
            if (skosConceptScheme == null)
                throw new OWLSemanticsException("Cannot create data lens because given \"skosConceptScheme\" parameter is null");
