...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEOOverlapsExpression : GEOExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFExpression leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument)
        {
        ...
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFExpression leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFExpression leftArgument, RDFTypedLiteral rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        ...
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFVariable leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFVariable leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfOverlaps function with given arguments
        /// </summary>
        public GEOOverlapsExpression(RDFVariable leftArgument, RDFTypedLiteral rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (!rightArgument.Datatype.Equals(RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)
