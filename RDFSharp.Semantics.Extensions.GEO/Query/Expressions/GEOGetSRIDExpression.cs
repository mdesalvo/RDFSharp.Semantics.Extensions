...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEOGetSRIDExpression : GEOExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a geof:getSRID function with given arguments
        /// </summary>
        public GEOGetSRIDExpression(RDFExpression leftArgument) : base(leftArgument, null) { }

        /// <summary>
        /// Default-ctor to build a geof:getSRID function with given arguments
        /// </summary>
        public GEOGetSRIDExpression(RDFVariable leftArgument) : base(leftArgument, null) { }
        #endregion
