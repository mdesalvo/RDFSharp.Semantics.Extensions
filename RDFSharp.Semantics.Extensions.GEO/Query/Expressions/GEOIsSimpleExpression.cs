...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEOIsSimpleExpression : GEOExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a geosparql:isSimple function with given arguments
        /// </summary>
        public GEOIsSimpleExpression(RDFExpression leftArgument) : base(leftArgument, null) { }

        /// <summary>
        /// Default-ctor to build a geosparql:isSimple function with given arguments
        /// </summary>
        public GEOIsSimpleExpression(RDFVariable leftArgument) : base(leftArgument, null) { }
        #endregion
