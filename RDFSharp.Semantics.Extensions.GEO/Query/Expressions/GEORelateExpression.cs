...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEORelateExpression : GEOExpression
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        public GEORelateExpression(RDFExpression leftArgument, RDFExpression rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
        ...
        /// Default-ctor to build a geof:sfRelate function with given arguments
        /// </summary>
        public GEORelateExpression(RDFExpression leftArgument, RDFVariable rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (string.IsNullOrWhiteSpace(de9imRelation))
        ...
        /// Default-ctor to build a geof:sfRelate function with given arguments
        /// </summary>
        public GEORelateExpression(RDFExpression leftArgument, RDFTypedLiteral rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        ...
        /// Default-ctor to build a geof:sfRelate function with given arguments
        /// </summary>
        public GEORelateExpression(RDFVariable leftArgument, RDFExpression rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (string.IsNullOrWhiteSpace(de9imRelation))
        ...
        /// Default-ctor to build a geof:sfRelate function with given arguments
        /// </summary>
        public GEORelateExpression(RDFVariable leftArgument, RDFVariable rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (string.IsNullOrWhiteSpace(de9imRelation))
        ...
        /// Default-ctor to build a geof:sfRelate function with given arguments
        /// </summary>
        public GEORelateExpression(RDFVariable leftArgument, RDFTypedLiteral rightArgument, string de9imRelation) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (!rightArgument.Datatype.Equals(RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)
