...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEOIsEmptyExpression : GEOExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a geosparql:isEmpty function with given arguments
        /// </summary>
        public GEOIsEmptyExpression(RDFExpression leftArgument) : base(leftArgument, null) { }

        /// <summary>
        /// Default-ctor to build a geosparql:isEmpty function with given arguments
        /// </summary>
        public GEOIsEmptyExpression(RDFVariable leftArgument) : base(leftArgument, null) { }
        #endregion
