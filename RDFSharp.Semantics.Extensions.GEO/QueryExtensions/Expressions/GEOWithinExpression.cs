...
namespace RDFSharp.Semantics.Extensions.GEO
{
    ...
    /// </summary>
    public class GEOWithinExpression : GEOExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFExpression leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument)
        {
        ...
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFExpression leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFExpression leftArgument, RDFTypedLiteral rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        ...
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFVariable leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFVariable leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
        }
        ...
        /// Default-ctor to build a geof:sfWithin function with given arguments
        /// </summary>
        public GEOWithinExpression(RDFVariable leftArgument, RDFTypedLiteral rightArgument) : base(leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new RDFQueryException("Cannot create expression because given \"rightArgument\" parameter is null");
            if (!rightArgument.Datatype.Equals(RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)
