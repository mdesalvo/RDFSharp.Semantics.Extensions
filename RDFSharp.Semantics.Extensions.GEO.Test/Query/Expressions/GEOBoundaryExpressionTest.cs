...
{
    [TestClass]
    public class GEOBoundaryExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOBoundaryExpressionWithExpression()
        {
            GEOBoundaryExpression expression = new GEOBoundaryExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEOBoundaryExpressionWithEXPBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOBoundaryExpression(null as RDFVariableExpression));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOBoundaryExpressionWithVARBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOBoundaryExpression(null as RDFVariable));
