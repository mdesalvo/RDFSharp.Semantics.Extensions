...
{
    [TestClass]
    public class GEOConvexHullExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOConvexHullExpressionWithExpression()
        {
            GEOConvexHullExpression expression = new GEOConvexHullExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEOConvexHullExpressionWithEXPBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOConvexHullExpression(null as RDFVariableExpression));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOConvexHullExpressionWithVARBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOConvexHullExpression(null as RDFVariable));
