...
{
    [TestClass]
    public class GEORCC8ExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEORCC8ExpressionWithExpressions()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                ...
                GEOEnums.GEORCC8Relations.RCC8DC);
        ...
        public void ShouldCreateGEORCC8ExpressionWithExpressionAndVariable()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFConstantExpression(new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)),
                new RDFVariable("?V"),
                GEOEnums.GEORCC8Relations.RCC8EC);
        ...
        public void ShouldCreateGEORCC8ExpressionWithExpressionAndTypedLiteral()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                ...
                GEOEnums.GEORCC8Relations.RCC8EQ);
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndExpression()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFVariable("?V"),
                new RDFConstantExpression(new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)),
                GEOEnums.GEORCC8Relations.RCC8NTPP);
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariables()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFVariable("?V1"),
                new RDFVariable("?V2"),
                GEOEnums.GEORCC8Relations.RCC8NTPPI);
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral1()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEORCC8Relations.RCC8PO);
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral2()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEORCC8Relations.RCC8TPP);
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral3()
        {
            GEORCC8Expression expression = new GEORCC8Expression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEORCC8Relations.RCC8TPPI);
        ...
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariableExpression, new RDFVariableExpression(new RDFVariable("?V")), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariableExpression, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariableExpression, new RDFVariable("?V"), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariable, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariableExpression, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFTypedLiteral, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariable, new RDFVariableExpression(new RDFVariable("?V")), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariable("?V"), null as RDFVariableExpression, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariable, new RDFVariable("?V"), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariable("?V"), null as RDFVariable, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(null as RDFVariable, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariable("?V"), null as RDFTypedLiteral, GEOEnums.GEORCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORCC8Expression(new RDFVariable("?V"), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), GEOEnums.GEORCC8Relations.RCC8DC));
