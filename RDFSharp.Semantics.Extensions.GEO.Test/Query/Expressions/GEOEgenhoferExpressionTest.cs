...
{
    [TestClass]
    public class GEOEgenhoferExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOEgenhoferExpressionWithExpressions()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                ...
                GEOEnums.GEOEgenhoferRelations.Contains);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithExpressionAndVariable()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFConstantExpression(new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)),
                new RDFVariable("?V"),
                GEOEnums.GEOEgenhoferRelations.CoveredBy);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithExpressionAndTypedLiteral()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                ...
                GEOEnums.GEOEgenhoferRelations.Covers);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithVariableAndExpression()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFVariable("?V"),
                new RDFConstantExpression(new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)),
                GEOEnums.GEOEgenhoferRelations.Disjoint);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithVariables()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFVariable("?V1"),
                new RDFVariable("?V2"),
                GEOEnums.GEOEgenhoferRelations.Equals);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithVariableAndTypedLiteral1()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEOEgenhoferRelations.Inside);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithVariableAndTypedLiteral2()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEOEgenhoferRelations.Meet);
        ...
        public void ShouldCreateGEOEgenhoferExpressionWithVariableAndTypedLiteral3()
        {
            GEOEgenhoferExpression expression = new GEOEgenhoferExpression(
                new RDFVariable("?V"),
                new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT),
                GEOEnums.GEOEgenhoferRelations.Overlap);
        ...
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithEEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariableExpression, new RDFVariableExpression(new RDFVariable("?V")), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithEEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariableExpression, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithEVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariableExpression, new RDFVariable("?V"), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithEVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariable, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithETBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariableExpression, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithETBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFTypedLiteral, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithETBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariable, new RDFVariableExpression(new RDFVariable("?V")), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariable("?V"), null as RDFVariableExpression, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariable, new RDFVariable("?V"), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariable("?V"), null as RDFVariable, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVTBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(null as RDFVariable, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVTBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariable("?V"), null as RDFTypedLiteral, GEOEnums.GEOEgenhoferRelations.Equals));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOEgenhoferExpressionWithVTBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOEgenhoferExpression(new RDFVariable("?V"), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), GEOEnums.GEOEgenhoferRelations.Equals));
