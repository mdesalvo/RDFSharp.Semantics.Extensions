...
{
    [TestClass]
    public class GEOIsEmptyExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOIsEmptyExpressionWithExpression()
        {
            GEOIsEmptyExpression expression = new GEOIsEmptyExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEOIsEmptyExpressionWithEXPBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOIsEmptyExpression(null as RDFVariableExpression));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOIsEmptyExpressionWithVARBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOIsEmptyExpression(null as RDFVariable));
