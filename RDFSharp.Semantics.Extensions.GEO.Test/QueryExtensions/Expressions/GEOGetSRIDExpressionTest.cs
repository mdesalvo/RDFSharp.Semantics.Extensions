...
{
    [TestClass]
    public class GEOGetSRIDExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOGetSRIDExpressionWithExpression()
        {
            GEOGetSRIDExpression expression = new GEOGetSRIDExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEOGetSRIDExpressionWithEXPBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOGetSRIDExpression(null as RDFVariableExpression));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOGetSRIDExpressionWithVARBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOGetSRIDExpression(null as RDFVariable));
