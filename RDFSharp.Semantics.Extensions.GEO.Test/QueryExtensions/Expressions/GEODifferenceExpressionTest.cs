...
namespace RDFSharp.Semantics.Extensions.GEO.Test
{
    ...
    public class GEODifferenceExpressionTest
    {
        ...
        public void ShouldApplyExpressionWithETAndCalculateResult()
        {
            ...
            Assert.IsTrue(expressionResult.Equals(new RDFTypedLiteral("POLYGON ((9.188690185546873 45.46590974421454, 8.916778564453123 44.406316252661384, 7.667083740233879 45.056061242743695, 9.188690185546873 45.46590974421454), (8.488311767578118 45.133617600708256, 8.205413818359336 44.894795764697875, 8.592681884765621 44.90841397875737, 8.488311767578118 45.133617600708256))", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)));
        }
