...
{
    [TestClass]
    public class GEORelateExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEORelateExpressionWithExpressions()
        {
            GEORelateExpression expression = new GEORelateExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariableExpression, new RDFVariableExpression(new RDFVariable("?V")), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariableExpression, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEEBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariableExpression(new RDFVariable("?V")), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEEBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariableExpression(new RDFVariable("?V")), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEEBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariableExpression(new RDFVariable("?V")), "019TF**FT")); //9 is not allowed char

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariableExpression, new RDFVariable("?V"), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariable, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEVBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariable("?V"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEVBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariable("?V"), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithEVBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFVariable("?V"), "019TF**FT")); //9 is not allowed char

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariableExpression, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFTypedLiteral, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithETBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "019TF**FT")); //9 is not allowed char

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariable, new RDFVariableExpression(new RDFVariable("?V")), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), null as RDFVariableExpression, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVEBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariableExpression(new RDFVariable("?V")), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVEBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariableExpression(new RDFVariable("?V")), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVEBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariableExpression(new RDFVariable("?V")), "019TF**FT")); //9 is not allowed char

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariable, new RDFVariable("?V"), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), null as RDFVariable, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVVBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariable("?V"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVVBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariable("?V"), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVVBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFVariable("?V"), "019TF**FT")); //9 is not allowed char

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(null as RDFVariable, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), null as RDFTypedLiteral, "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), "012TF**FT"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseNullDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), null));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseTooLongDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "012TF**FT2")); //10 chars

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORelateExpressionWithVTBecauseInvalidDE9IMRelation()
            => Assert.ThrowsException<RDFQueryException>(() => new GEORelateExpression(new RDFVariable("?V"), new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), "019TF**FT")); //9 is not allowed char
