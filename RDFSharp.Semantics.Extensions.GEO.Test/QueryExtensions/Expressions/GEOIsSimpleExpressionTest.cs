...
{
    [TestClass]
    public class GEOIsSimpleExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateGEOIsSimpleExpressionWithExpression()
        {
            GEOIsSimpleExpression expression = new GEOIsSimpleExpression(
        ...
        public void ShouldThrowExceptionOnCreatingGEOIsSimpleExpressionWithEXPBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOIsSimpleExpression(null as RDFVariableExpression));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEOIsSimpleExpressionWithVARBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new GEOIsSimpleExpression(null as RDFVariable));
